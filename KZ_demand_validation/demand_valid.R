...
# load demand data (adapted from KEGOS reports) --------------------------------
...
mutate(
    demand_korem_nz = (
        demand_korem - mean(demand_korem, na.rm = TRUE))/sd(demand_korem, na.rm = TRUE
    )
)
...
# cross-check with aggregated values -------------------------------------------
